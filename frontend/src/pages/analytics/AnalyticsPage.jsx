...
export const AnalyticsPage = () => {
  ...
  if (loading) {
    return <LoadingSpinner fullPage message="Aggregating workforce intelligence..." />;
  }
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500">
          Reconciled operational metrics across headcount, attendance, leaves, skills, and attrition
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-3.5 bg-rose-50/50 border border-rose-100 rounded-lg">
